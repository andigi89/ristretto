...
rstto_preferences_dialog_init ( RsttoPreferencesDialog *dialog )
{
    ...
    gtk_label_set_xalign (GTK_LABEL (dialog->priv->display_tab.quality_label), 0);
    ...
    gtk_label_set_xalign (GTK_LABEL (dialog->priv->fullscreen_tab.hide_thumbnails_fullscreen_lbl), 0);
    ...
    gtk_label_set_xalign (GTK_LABEL (dialog->priv->fullscreen_tab.clock_label), 0);
    ...
    gtk_label_set_xalign (GTK_LABEL(timeout_lbl), 0);
    gtk_label_set_yalign (GTK_LABEL(timeout_lbl), 0.5);
    gtk_widget_set_margin_start (timeout_lbl, 2);
    gtk_widget_set_margin_end (timeout_lbl, 2);
